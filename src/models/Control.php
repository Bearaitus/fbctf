...
class Control extends Model {
  ...
  public static async function genBegin(): Awaitable<void> {
    ...
    await \HH\Asio\va(
      Announcement::genCreateAuto(tr('Game has started!')), // Announce game starting
      ActivityLog::genCreateGenericLog(tr('Game has started!')), // Log game starting
  ...
  public static async function genEnd(): Awaitable<void> {
    await \HH\Asio\va(
      Announcement::genCreateAuto(tr('Game has ended!')), // Announce game ending
      ActivityLog::genCreateGenericLog(tr('Game has ended!')), // Log game ending
  ...
  public static async function genPause(): Awaitable<void> {
    await \HH\Asio\va(
      Announcement::genCreateAuto(tr('Game has been paused!')), // Announce game paused
      ActivityLog::genCreateGenericLog(tr('Game has been paused!')), // Log game paused
      Configuration::genUpdate('scoring', '0'), // Disable scoring
    );
    $pause_ts = time();
    await \HH\Asio\va(
  ...
  public static async function genUnpause(): Awaitable<void> {
    ...
    await \HH\Asio\va(
      ...
      Level::genBaseScoring(), // Kick off scoring for bases
      Announcement::genCreateAuto(tr('Game has resumed!')), // Announce game resumed
      ActivityLog::genCreateGenericLog(tr('Game has resumed!')), // Log game resumed
    );
  }
